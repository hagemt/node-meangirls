...
const parseCRDT = (anyCRDT = null) => {
	...
	switch (type) {
		case '2p-set':
			return TwoPSet.fromJSON(anyCRDT)
		case 'g-counter':
			return GCounter.fromJSON(anyCRDT)
		case 'g-set':
			return GSet.fromJSON(anyCRDT)
		case 'lww-e-set':
			return LWWESet.fromJSON(anyCRDT)
		case 'mc-set':
			return MCSet.fromJSON(anyCRDT)
		case 'or-set':
			return ORSet.fromJSON(anyCRDT)
		case 'pn-counter':
			return PNCounter.fromJSON(anyCRDT)
		default:
